# Bash
**What is Bash?**
Bash is a program that lets you tell your computer what to do using text commands. Think of it like giving instructions step by step.
- It’s like talking to your computer instead of clicking icons.
- You type commands, and Bash runs them.
- You can also write scripts—a list of commands saved in a file—so the computer can do things automatically.
